...
from qdrant_client.local.sparse import sort_sparse_vector, validate_sparse_vector
...
class SparseRecoQuery:
    def __init__(
        self,
        positive: Optional[List[models.SparseVector]] = None,
        negative: Optional[List[models.SparseVector]] = None,
    ):
        positive = positive if positive is not None else []
        negative = negative if negative is not None else []
