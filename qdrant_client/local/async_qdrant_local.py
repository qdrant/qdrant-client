...
class AsyncQdrantLocal(AsyncQdrantBase):
    ...
    async def search_matrix_offsets(
        ...
        **kwargs: Any,
        ...
        return await asyncio.to_thread(
            collection.search_matrix_offsets,
    ...
    async def search_matrix_pairs(
        ...
        **kwargs: Any,
        ...
        collection = self._get_collection(collection_name)
        return await asyncio.to_thread(
            collection.search_matrix_pairs,
            query_filter=query_filter,
            limit=limit,
            sample=sample,
            using=using,
    ...
    async def count(
        ...
        **kwargs: Any,
        ...
        collection = self._get_collection(collection_name)
        return await asyncio.to_thread(collection.count, count_filter=count_filter)
    ...
    async def facet(
        ...
        **kwargs: Any,
        ...
        collection = self._get_collection(collection_name)
        return await asyncio.to_thread(
            collection.facet, key=key, facet_filter=facet_filter, limit=limit
        )
    ...
    async def retrieve(
        ...
        **kwargs: Any,
        ...
        collection = self._get_collection(collection_name)
        return await asyncio.to_thread(collection.retrieve, ids, with_payload, with_vectors)
