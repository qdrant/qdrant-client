...
from qdrant_client.http import SyncApis, AsyncApis
...
class QdrantClientAsync:
    """Asynchronous version of entry point to communicate with Qdrant service via REST or gPRC API.
    ...
    def __init__(self,
        ...
        self._host = host
        self._port = port
        self.openapi_client = AsyncApis(host=f"http://{host}:{port}", **kwargs)
    ...
    async def search(self,
        ...
        if self._prefer_grpc:
            ...
            res: grpc.SearchResponse = await self._grpc_points_client.search(
            ...
            search_result = await self.rest.points_api.search_points(
                collection_name=collection_name,
    ...
    async def delete_collection(self, collection_name: str):
        ...
        return await self.rest.collections_api.delete_collection(collection_name)
    ...
    async def recreate_collection(self,
        ...
        return await self.rest.collections_api.create_collection(
            collection_name=collection_name,
    ...
    async def create_payload_index(self,
        ...
        return await self.openapi_client.collections_api.create_field_index(
            collection_name=collection_name,
            create_field_index=rest.CreateFieldIndex(field_name=field_name, field_type=field_type),
            wait=wait
        )

    async def delete_payload_index(self, collection_name: str, field_name: str):
        ...
        Returns:
            Operation Result
        """
        return await self.openapi_client.collections_api.delete_field_index(
            collection_name=collection_name,
