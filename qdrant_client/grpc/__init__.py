...
# sources: collections.proto, collections_service.proto, json_with_int.proto, points.proto, points_service.proto, qdrant.proto, snapshots_service.proto
...
class PointsStub(betterproto.ServiceStub):
    ...
    async def count(
        ...
        *,
        ...
        return await self._unary_unary("/qdrant.Points/Count", request, CountResponse)
...
class SnapshotsStub(betterproto.ServiceStub):
    async def create(self, *, collection_name: str = "") -> "CreateSnapshotResponse":
        ...
        return await self._unary_unary(
            "/qdrant.Snapshots/Create", request, CreateSnapshotResponse
        )
...
class SnapshotsBase(ServiceBase):
    ...
    def __mapping__(self) -> Dict[str, grpclib.const.Handler]:
        return {
            ...
            "/qdrant.Snapshots/List": grpclib.const.Handler(
                self.__rpc_list,
                grpclib.const.Cardinality.UNARY_UNARY,
