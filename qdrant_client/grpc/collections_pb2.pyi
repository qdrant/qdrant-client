...
class VectorParams(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["_datatype", b"_datatype", "_hnsw_config", b"_hnsw_config", "_multivector_config", b"_multivector_config", "_on_disk", b"_on_disk", "_quantization_config", b"_quantization_config", "datatype", b"datatype", "hnsw_config", b"hnsw_config", "multivector_config", b"multivector_config", "on_disk", b"on_disk", "quantization_config", b"quantization_config"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["_datatype", b"_datatype", "_hnsw_config", b"_hnsw_config", "_multivector_config", b"_multivector_config", "_on_disk", b"_on_disk", "_quantization_config", b"_quantization_config", "datatype", b"datatype", "distance", b"distance", "hnsw_config", b"hnsw_config", "multivector_config", b"multivector_config", "on_disk", b"on_disk", "quantization_config", b"quantization_config", "size", b"size"]) -> None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing.Literal["_datatype", b"_datatype"]) -> typing.Literal["datatype"] | None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing.Literal["_hnsw_config", b"_hnsw_config"]) -> typing.Literal["hnsw_config"] | None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing.Literal["_multivector_config", b"_multivector_config"]) -> typing.Literal["multivector_config"] | None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing.Literal["_on_disk", b"_on_disk"]) -> typing.Literal["on_disk"] | None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing.Literal["_quantization_config", b"_quantization_config"]) -> typing.Literal["quantization_config"] | None: ...
...
class VectorParamsDiff(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["_hnsw_config", b"_hnsw_config", "_on_disk", b"_on_disk", "_quantization_config", b"_quantization_config", "hnsw_config", b"hnsw_config", "on_disk", b"on_disk", "quantization_config", b"quantization_config"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["_hnsw_config", b"_hnsw_config", "_on_disk", b"_on_disk", "_quantization_config", b"_quantization_config", "hnsw_config", b"hnsw_config", "on_disk", b"on_disk", "quantization_config", b"quantization_config"]) -> None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing.Literal["_hnsw_config", b"_hnsw_config"]) -> typing.Literal["hnsw_config"] | None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing.Literal["_on_disk", b"_on_disk"]) -> typing.Literal["on_disk"] | None: ...
...
class VectorsConfig(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["config", b"config", "params", b"params", "params_map", b"params_map"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["config", b"config", "params", b"params", "params_map", b"params_map"]) -> None: ...
    def WhichOneof(self, oneof_group: typing.Literal["config", b"config"]) -> typing.Literal["params", "params_map"] | None: ...
...
class SparseVectorParams(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["_index", b"_index", "_modifier", b"_modifier", "index", b"index", "modifier", b"modifier"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["_index", b"_index", "_modifier", b"_modifier", "index", b"index", "modifier", b"modifier"]) -> None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing.Literal["_index", b"_index"]) -> typing.Literal["index"] | None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing.Literal["_modifier", b"_modifier"]) -> typing.Literal["modifier"] | None: ...
...
class MultiVectorConfig(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["comparator", b"comparator"]) -> None: ...
...
class ListCollectionsResponse(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["collections", b"collections", "time", b"time"]) -> None: ...
...
class HnswConfigDiff(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["_ef_construct", b"_ef_construct", "_full_scan_threshold", b"_full_scan_threshold", "_m", b"_m", "_max_indexing_threads", b"_max_indexing_threads", "_on_disk", b"_on_disk", "_payload_m", b"_payload_m", "ef_construct", b"ef_construct", "full_scan_threshold", b"full_scan_threshold", "m", b"m", "max_indexing_threads", b"max_indexing_threads", "on_disk", b"on_disk", "payload_m", b"payload_m"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["_ef_construct", b"_ef_construct", "_full_scan_threshold", b"_full_scan_threshold", "_m", b"_m", "_max_indexing_threads", b"_max_indexing_threads", "_on_disk", b"_on_disk", "_payload_m", b"_payload_m", "ef_construct", b"ef_construct", "full_scan_threshold", b"full_scan_threshold", "m", b"m", "max_indexing_threads", b"max_indexing_threads", "on_disk", b"on_disk", "payload_m", b"payload_m"]) -> None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing.Literal["_ef_construct", b"_ef_construct"]) -> typing.Literal["ef_construct"] | None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing.Literal["_full_scan_threshold", b"_full_scan_threshold"]) -> typing.Literal["full_scan_threshold"] | None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing.Literal["_m", b"_m"]) -> typing.Literal["m"] | None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing.Literal["_max_indexing_threads", b"_max_indexing_threads"]) -> typing.Literal["max_indexing_threads"] | None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing.Literal["_on_disk", b"_on_disk"]) -> typing.Literal["on_disk"] | None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing.Literal["_payload_m", b"_payload_m"]) -> typing.Literal["payload_m"] | None: ...
...
class SparseIndexConfig(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["_datatype", b"_datatype", "_full_scan_threshold", b"_full_scan_threshold", "_on_disk", b"_on_disk", "datatype", b"datatype", "full_scan_threshold", b"full_scan_threshold", "on_disk", b"on_disk"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["_datatype", b"_datatype", "_full_scan_threshold", b"_full_scan_threshold", "_on_disk", b"_on_disk", "datatype", b"datatype", "full_scan_threshold", b"full_scan_threshold", "on_disk", b"on_disk"]) -> None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing.Literal["_datatype", b"_datatype"]) -> typing.Literal["datatype"] | None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing.Literal["_full_scan_threshold", b"_full_scan_threshold"]) -> typing.Literal["full_scan_threshold"] | None: ...
...
class WalConfigDiff(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["_wal_capacity_mb", b"_wal_capacity_mb", "_wal_segments_ahead", b"_wal_segments_ahead", "wal_capacity_mb", b"wal_capacity_mb", "wal_segments_ahead", b"wal_segments_ahead"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["_wal_capacity_mb", b"_wal_capacity_mb", "_wal_segments_ahead", b"_wal_segments_ahead", "wal_capacity_mb", b"wal_capacity_mb", "wal_segments_ahead", b"wal_segments_ahead"]) -> None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing.Literal["_wal_capacity_mb", b"_wal_capacity_mb"]) -> typing.Literal["wal_capacity_mb"] | None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing.Literal["_wal_segments_ahead", b"_wal_segments_ahead"]) -> typing.Literal["wal_segments_ahead"] | None: ...
...
class OptimizersConfigDiff(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["_default_segment_number", b"_default_segment_number", "_deleted_threshold", b"_deleted_threshold", "_flush_interval_sec", b"_flush_interval_sec", "_indexing_threshold", b"_indexing_threshold", "_max_optimization_threads", b"_max_optimization_threads", "_max_segment_size", b"_max_segment_size", "_memmap_threshold", b"_memmap_threshold", "_vacuum_min_vector_number", b"_vacuum_min_vector_number", "default_segment_number", b"default_segment_number", "deleted_threshold", b"deleted_threshold", "flush_interval_sec", b"flush_interval_sec", "indexing_threshold", b"indexing_threshold", "max_optimization_threads", b"max_optimization_threads", "max_segment_size", b"max_segment_size", "memmap_threshold", b"memmap_threshold", "vacuum_min_vector_number", b"vacuum_min_vector_number"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["_default_segment_number", b"_default_segment_number", "_deleted_threshold", b"_deleted_threshold", "_flush_interval_sec", b"_flush_interval_sec", "_indexing_threshold", b"_indexing_threshold", "_max_optimization_threads", b"_max_optimization_threads", "_max_segment_size", b"_max_segment_size", "_memmap_threshold", b"_memmap_threshold", "_vacuum_min_vector_number", b"_vacuum_min_vector_number", "default_segment_number", b"default_segment_number", "deleted_threshold", b"deleted_threshold", "flush_interval_sec", b"flush_interval_sec", "indexing_threshold", b"indexing_threshold", "max_optimization_threads", b"max_optimization_threads", "max_segment_size", b"max_segment_size", "memmap_threshold", b"memmap_threshold", "vacuum_min_vector_number", b"vacuum_min_vector_number"]) -> None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing.Literal["_default_segment_number", b"_default_segment_number"]) -> typing.Literal["default_segment_number"] | None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing.Literal["_deleted_threshold", b"_deleted_threshold"]) -> typing.Literal["deleted_threshold"] | None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing.Literal["_flush_interval_sec", b"_flush_interval_sec"]) -> typing.Literal["flush_interval_sec"] | None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing.Literal["_indexing_threshold", b"_indexing_threshold"]) -> typing.Literal["indexing_threshold"] | None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing.Literal["_max_optimization_threads", b"_max_optimization_threads"]) -> typing.Literal["max_optimization_threads"] | None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing.Literal["_max_segment_size", b"_max_segment_size"]) -> typing.Literal["max_segment_size"] | None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing.Literal["_memmap_threshold", b"_memmap_threshold"]) -> typing.Literal["memmap_threshold"] | None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing.Literal["_vacuum_min_vector_number", b"_vacuum_min_vector_number"]) -> typing.Literal["vacuum_min_vector_number"] | None: ...
...
class ScalarQuantization(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["_always_ram", b"_always_ram", "_quantile", b"_quantile", "always_ram", b"always_ram", "quantile", b"quantile"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["_always_ram", b"_always_ram", "_quantile", b"_quantile", "always_ram", b"always_ram", "quantile", b"quantile", "type", b"type"]) -> None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing.Literal["_always_ram", b"_always_ram"]) -> typing.Literal["always_ram"] | None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing.Literal["_quantile", b"_quantile"]) -> typing.Literal["quantile"] | None: ...
...
class ProductQuantization(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["_always_ram", b"_always_ram", "always_ram", b"always_ram"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["_always_ram", b"_always_ram", "always_ram", b"always_ram", "compression", b"compression"]) -> None: ...
    def WhichOneof(self, oneof_group: typing.Literal["_always_ram", b"_always_ram"]) -> typing.Literal["always_ram"] | None: ...
...
class BinaryQuantization(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["_always_ram", b"_always_ram", "always_ram", b"always_ram"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["_always_ram", b"_always_ram", "always_ram", b"always_ram"]) -> None: ...
    def WhichOneof(self, oneof_group: typing.Literal["_always_ram", b"_always_ram"]) -> typing.Literal["always_ram"] | None: ...
...
class QuantizationConfig(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["binary", b"binary", "product", b"product", "quantization", b"quantization", "scalar", b"scalar"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["binary", b"binary", "product", b"product", "quantization", b"quantization", "scalar", b"scalar"]) -> None: ...
    def WhichOneof(self, oneof_group: typing.Literal["quantization", b"quantization"]) -> typing.Literal["scalar", "product", "binary"] | None: ...
...
class QuantizationConfigDiff(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["binary", b"binary", "disabled", b"disabled", "product", b"product", "quantization", b"quantization", "scalar", b"scalar"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["binary", b"binary", "disabled", b"disabled", "product", b"product", "quantization", b"quantization", "scalar", b"scalar"]) -> None: ...
    def WhichOneof(self, oneof_group: typing.Literal["quantization", b"quantization"]) -> typing.Literal["scalar", "product", "disabled", "binary"] | None: ...
...
class StrictModeConfig(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["_enabled", b"_enabled", "_max_query_limit", b"_max_query_limit", "_max_timeout", b"_max_timeout", "_search_allow_exact", b"_search_allow_exact", "_search_max_hnsw_ef", b"_search_max_hnsw_ef", "_search_max_oversampling", b"_search_max_oversampling", "_unindexed_filtering_retrieve", b"_unindexed_filtering_retrieve", "_unindexed_filtering_update", b"_unindexed_filtering_update", "enabled", b"enabled", "max_query_limit", b"max_query_limit", "max_timeout", b"max_timeout", "search_allow_exact", b"search_allow_exact", "search_max_hnsw_ef", b"search_max_hnsw_ef", "search_max_oversampling", b"search_max_oversampling", "unindexed_filtering_retrieve", b"unindexed_filtering_retrieve", "unindexed_filtering_update", b"unindexed_filtering_update"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["_enabled", b"_enabled", "_max_query_limit", b"_max_query_limit", "_max_timeout", b"_max_timeout", "_search_allow_exact", b"_search_allow_exact", "_search_max_hnsw_ef", b"_search_max_hnsw_ef", "_search_max_oversampling", b"_search_max_oversampling", "_unindexed_filtering_retrieve", b"_unindexed_filtering_retrieve", "_unindexed_filtering_update", b"_unindexed_filtering_update", "enabled", b"enabled", "max_query_limit", b"max_query_limit", "max_timeout", b"max_timeout", "search_allow_exact", b"search_allow_exact", "search_max_hnsw_ef", b"search_max_hnsw_ef", "search_max_oversampling", b"search_max_oversampling", "unindexed_filtering_retrieve", b"unindexed_filtering_retrieve", "unindexed_filtering_update", b"unindexed_filtering_update"]) -> None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing.Literal["_enabled", b"_enabled"]) -> typing.Literal["enabled"] | None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing.Literal["_max_query_limit", b"_max_query_limit"]) -> typing.Literal["max_query_limit"] | None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing.Literal["_max_timeout", b"_max_timeout"]) -> typing.Literal["max_timeout"] | None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing.Literal["_search_allow_exact", b"_search_allow_exact"]) -> typing.Literal["search_allow_exact"] | None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing.Literal["_search_max_hnsw_ef", b"_search_max_hnsw_ef"]) -> typing.Literal["search_max_hnsw_ef"] | None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing.Literal["_search_max_oversampling", b"_search_max_oversampling"]) -> typing.Literal["search_max_oversampling"] | None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing.Literal["_unindexed_filtering_retrieve", b"_unindexed_filtering_retrieve"]) -> typing.Literal["unindexed_filtering_retrieve"] | None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing.Literal["_unindexed_filtering_update", b"_unindexed_filtering_update"]) -> typing.Literal["unindexed_filtering_update"] | None: ...
...
class CreateCollection(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["_hnsw_config", b"_hnsw_config", "_init_from_collection", b"_init_from_collection", "_on_disk_payload", b"_on_disk_payload", "_optimizers_config", b"_optimizers_config", "_quantization_config", b"_quantization_config", "_replication_factor", b"_replication_factor", "_shard_number", b"_shard_number", "_sharding_method", b"_sharding_method", "_sparse_vectors_config", b"_sparse_vectors_config", "_strict_mode_config", b"_strict_mode_config", "_timeout", b"_timeout", "_vectors_config", b"_vectors_config", "_wal_config", b"_wal_config", "_write_consistency_factor", b"_write_consistency_factor", "hnsw_config", b"hnsw_config", "init_from_collection", b"init_from_collection", "on_disk_payload", b"on_disk_payload", "optimizers_config", b"optimizers_config", "quantization_config", b"quantization_config", "replication_factor", b"replication_factor", "shard_number", b"shard_number", "sharding_method", b"sharding_method", "sparse_vectors_config", b"sparse_vectors_config", "strict_mode_config", b"strict_mode_config", "timeout", b"timeout", "vectors_config", b"vectors_config", "wal_config", b"wal_config", "write_consistency_factor", b"write_consistency_factor"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["_hnsw_config", b"_hnsw_config", "_init_from_collection", b"_init_from_collection", "_on_disk_payload", b"_on_disk_payload", "_optimizers_config", b"_optimizers_config", "_quantization_config", b"_quantization_config", "_replication_factor", b"_replication_factor", "_shard_number", b"_shard_number", "_sharding_method", b"_sharding_method", "_sparse_vectors_config", b"_sparse_vectors_config", "_strict_mode_config", b"_strict_mode_config", "_timeout", b"_timeout", "_vectors_config", b"_vectors_config", "_wal_config", b"_wal_config", "_write_consistency_factor", b"_write_consistency_factor", "collection_name", b"collection_name", "hnsw_config", b"hnsw_config", "init_from_collection", b"init_from_collection", "on_disk_payload", b"on_disk_payload", "optimizers_config", b"optimizers_config", "quantization_config", b"quantization_config", "replication_factor", b"replication_factor", "shard_number", b"shard_number", "sharding_method", b"sharding_method", "sparse_vectors_config", b"sparse_vectors_config", "strict_mode_config", b"strict_mode_config", "timeout", b"timeout", "vectors_config", b"vectors_config", "wal_config", b"wal_config", "write_consistency_factor", b"write_consistency_factor"]) -> None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing.Literal["_hnsw_config", b"_hnsw_config"]) -> typing.Literal["hnsw_config"] | None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing.Literal["_init_from_collection", b"_init_from_collection"]) -> typing.Literal["init_from_collection"] | None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing.Literal["_on_disk_payload", b"_on_disk_payload"]) -> typing.Literal["on_disk_payload"] | None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing.Literal["_optimizers_config", b"_optimizers_config"]) -> typing.Literal["optimizers_config"] | None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing.Literal["_quantization_config", b"_quantization_config"]) -> typing.Literal["quantization_config"] | None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing.Literal["_replication_factor", b"_replication_factor"]) -> typing.Literal["replication_factor"] | None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing.Literal["_shard_number", b"_shard_number"]) -> typing.Literal["shard_number"] | None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing.Literal["_sharding_method", b"_sharding_method"]) -> typing.Literal["sharding_method"] | None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing.Literal["_sparse_vectors_config", b"_sparse_vectors_config"]) -> typing.Literal["sparse_vectors_config"] | None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing.Literal["_strict_mode_config", b"_strict_mode_config"]) -> typing.Literal["strict_mode_config"] | None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing.Literal["_timeout", b"_timeout"]) -> typing.Literal["timeout"] | None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing.Literal["_vectors_config", b"_vectors_config"]) -> typing.Literal["vectors_config"] | None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing.Literal["_wal_config", b"_wal_config"]) -> typing.Literal["wal_config"] | None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing.Literal["_write_consistency_factor", b"_write_consistency_factor"]) -> typing.Literal["write_consistency_factor"] | None: ...
...
class DeleteCollection(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["_timeout", b"_timeout", "collection_name", b"collection_name", "timeout", b"timeout"]) -> None: ...
    def WhichOneof(self, oneof_group: typing.Literal["_timeout", b"_timeout"]) -> typing.Literal["timeout"] | None: ...
...
class KeywordIndexParams(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["_is_tenant", b"_is_tenant", "_on_disk", b"_on_disk", "is_tenant", b"is_tenant", "on_disk", b"on_disk"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["_is_tenant", b"_is_tenant", "_on_disk", b"_on_disk", "is_tenant", b"is_tenant", "on_disk", b"on_disk"]) -> None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing.Literal["_is_tenant", b"_is_tenant"]) -> typing.Literal["is_tenant"] | None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing.Literal["_on_disk", b"_on_disk"]) -> typing.Literal["on_disk"] | None: ...
...
class IntegerIndexParams(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["_is_principal", b"_is_principal", "_lookup", b"_lookup", "_on_disk", b"_on_disk", "_range", b"_range", "is_principal", b"is_principal", "lookup", b"lookup", "on_disk", b"on_disk", "range", b"range"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["_is_principal", b"_is_principal", "_lookup", b"_lookup", "_on_disk", b"_on_disk", "_range", b"_range", "is_principal", b"is_principal", "lookup", b"lookup", "on_disk", b"on_disk", "range", b"range"]) -> None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing.Literal["_is_principal", b"_is_principal"]) -> typing.Literal["is_principal"] | None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing.Literal["_lookup", b"_lookup"]) -> typing.Literal["lookup"] | None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing.Literal["_on_disk", b"_on_disk"]) -> typing.Literal["on_disk"] | None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing.Literal["_range", b"_range"]) -> typing.Literal["range"] | None: ...
...
class FloatIndexParams(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["_is_principal", b"_is_principal", "_on_disk", b"_on_disk", "is_principal", b"is_principal", "on_disk", b"on_disk"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["_is_principal", b"_is_principal", "_on_disk", b"_on_disk", "is_principal", b"is_principal", "on_disk", b"on_disk"]) -> None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing.Literal["_is_principal", b"_is_principal"]) -> typing.Literal["is_principal"] | None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing.Literal["_on_disk", b"_on_disk"]) -> typing.Literal["on_disk"] | None: ...
...
class TextIndexParams(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["_lowercase", b"_lowercase", "_max_token_len", b"_max_token_len", "_min_token_len", b"_min_token_len", "lowercase", b"lowercase", "max_token_len", b"max_token_len", "min_token_len", b"min_token_len"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["_lowercase", b"_lowercase", "_max_token_len", b"_max_token_len", "_min_token_len", b"_min_token_len", "lowercase", b"lowercase", "max_token_len", b"max_token_len", "min_token_len", b"min_token_len", "tokenizer", b"tokenizer"]) -> None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing.Literal["_lowercase", b"_lowercase"]) -> typing.Literal["lowercase"] | None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing.Literal["_max_token_len", b"_max_token_len"]) -> typing.Literal["max_token_len"] | None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing.Literal["_min_token_len", b"_min_token_len"]) -> typing.Literal["min_token_len"] | None: ...
...
class PayloadIndexParams(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["bool_index_params", b"bool_index_params", "datetime_index_params", b"datetime_index_params", "float_index_params", b"float_index_params", "geo_index_params", b"geo_index_params", "index_params", b"index_params", "integer_index_params", b"integer_index_params", "keyword_index_params", b"keyword_index_params", "text_index_params", b"text_index_params", "uuid_index_params", b"uuid_index_params"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["bool_index_params", b"bool_index_params", "datetime_index_params", b"datetime_index_params", "float_index_params", b"float_index_params", "geo_index_params", b"geo_index_params", "index_params", b"index_params", "integer_index_params", b"integer_index_params", "keyword_index_params", b"keyword_index_params", "text_index_params", b"text_index_params", "uuid_index_params", b"uuid_index_params"]) -> None: ...
    def WhichOneof(self, oneof_group: typing.Literal["index_params", b"index_params"]) -> typing.Literal["keyword_index_params", "integer_index_params", "float_index_params", "geo_index_params", "text_index_params", "bool_index_params", "datetime_index_params", "uuid_index_params"] | None: ...
...
class PayloadSchemaInfo(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["_params", b"_params", "_points", b"_points", "params", b"params", "points", b"points"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["_params", b"_params", "_points", b"_points", "data_type", b"data_type", "params", b"params", "points", b"points"]) -> None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing.Literal["_params", b"_params"]) -> typing.Literal["params"] | None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing.Literal["_points", b"_points"]) -> typing.Literal["points"] | None: ...
...
class CollectionInfo(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["_indexed_vectors_count", b"_indexed_vectors_count", "_points_count", b"_points_count", "_vectors_count", b"_vectors_count", "config", b"config", "indexed_vectors_count", b"indexed_vectors_count", "optimizer_status", b"optimizer_status", "points_count", b"points_count", "vectors_count", b"vectors_count"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["_indexed_vectors_count", b"_indexed_vectors_count", "_points_count", b"_points_count", "_vectors_count", b"_vectors_count", "config", b"config", "indexed_vectors_count", b"indexed_vectors_count", "optimizer_status", b"optimizer_status", "payload_schema", b"payload_schema", "points_count", b"points_count", "segments_count", b"segments_count", "status", b"status", "vectors_count", b"vectors_count"]) -> None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing.Literal["_indexed_vectors_count", b"_indexed_vectors_count"]) -> typing.Literal["indexed_vectors_count"] | None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing.Literal["_points_count", b"_points_count"]) -> typing.Literal["points_count"] | None: ...
    @typing.overload
...
class ChangeAliases(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["_timeout", b"_timeout", "timeout", b"timeout"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["_timeout", b"_timeout", "actions", b"actions", "timeout", b"timeout"]) -> None: ...
    def WhichOneof(self, oneof_group: typing.Literal["_timeout", b"_timeout"]) -> typing.Literal["timeout"] | None: ...
...
class AliasOperations(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["action", b"action", "create_alias", b"create_alias", "delete_alias", b"delete_alias", "rename_alias", b"rename_alias"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["action", b"action", "create_alias", b"create_alias", "delete_alias", b"delete_alias", "rename_alias", b"rename_alias"]) -> None: ...
    def WhichOneof(self, oneof_group: typing.Literal["action", b"action"]) -> typing.Literal["create_alias", "rename_alias", "delete_alias"] | None: ...
...
class CreateAlias(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["alias_name", b"alias_name", "collection_name", b"collection_name"]) -> None: ...
...
class RenameAlias(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["new_alias_name", b"new_alias_name", "old_alias_name", b"old_alias_name"]) -> None: ...
...
class ListAliasesResponse(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["aliases", b"aliases", "time", b"time"]) -> None: ...
...
class ShardKey(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["key", b"key", "keyword", b"keyword", "number", b"number"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["key", b"key", "keyword", b"keyword", "number", b"number"]) -> None: ...
    def WhichOneof(self, oneof_group: typing.Literal["key", b"key"]) -> typing.Literal["keyword", "number"] | None: ...
...
class LocalShardInfo(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["_shard_key", b"_shard_key", "shard_key", b"shard_key"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["_shard_key", b"_shard_key", "points_count", b"points_count", "shard_id", b"shard_id", "shard_key", b"shard_key", "state", b"state"]) -> None: ...
...
class RemoteShardInfo(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["_shard_key", b"_shard_key", "shard_key", b"shard_key"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["_shard_key", b"_shard_key", "peer_id", b"peer_id", "shard_id", b"shard_id", "shard_key", b"shard_key", "state", b"state"]) -> None: ...
    def WhichOneof(self, oneof_group: typing.Literal["_shard_key", b"_shard_key"]) -> typing.Literal["shard_key"] | None: ...
...
class ShardTransferInfo(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["_to_shard_id", b"_to_shard_id", "to_shard_id", b"to_shard_id"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["_to_shard_id", b"_to_shard_id", "from", b"from", "shard_id", b"shard_id", "sync", b"sync", "to", b"to", "to_shard_id", b"to_shard_id"]) -> None: ...
    def WhichOneof(self, oneof_group: typing.Literal["_to_shard_id", b"_to_shard_id"]) -> typing.Literal["to_shard_id"] | None: ...
...
class ReshardingInfo(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["_shard_key", b"_shard_key", "shard_key", b"shard_key"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["_shard_key", b"_shard_key", "peer_id", b"peer_id", "shard_id", b"shard_id", "shard_key", b"shard_key"]) -> None: ...
    def WhichOneof(self, oneof_group: typing.Literal["_shard_key", b"_shard_key"]) -> typing.Literal["shard_key"] | None: ...
...
class CollectionClusterInfoResponse(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["local_shards", b"local_shards", "peer_id", b"peer_id", "remote_shards", b"remote_shards", "shard_count", b"shard_count", "shard_transfers", b"shard_transfers"]) -> None: ...
...
class MoveShard(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["_method", b"_method", "_to_shard_id", b"_to_shard_id", "method", b"method", "to_shard_id", b"to_shard_id"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["_method", b"_method", "_to_shard_id", b"_to_shard_id", "from_peer_id", b"from_peer_id", "method", b"method", "shard_id", b"shard_id", "to_peer_id", b"to_peer_id", "to_shard_id", b"to_shard_id"]) -> None: ...
    @typing.overload
...
class AbortShardTransfer(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["_to_shard_id", b"_to_shard_id", "to_shard_id", b"to_shard_id"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["_to_shard_id", b"_to_shard_id", "from_peer_id", b"from_peer_id", "shard_id", b"shard_id", "to_peer_id", b"to_peer_id", "to_shard_id", b"to_shard_id"]) -> None: ...
    def WhichOneof(self, oneof_group: typing.Literal["_to_shard_id", b"_to_shard_id"]) -> typing.Literal["to_shard_id"] | None: ...
...
class RestartTransfer(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["_to_shard_id", b"_to_shard_id", "to_shard_id", b"to_shard_id"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["_to_shard_id", b"_to_shard_id", "from_peer_id", b"from_peer_id", "method", b"method", "shard_id", b"shard_id", "to_peer_id", b"to_peer_id", "to_shard_id", b"to_shard_id"]) -> None: ...
    def WhichOneof(self, oneof_group: typing.Literal["_to_shard_id", b"_to_shard_id"]) -> typing.Literal["to_shard_id"] | None: ...
...
class Replica(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["peer_id", b"peer_id", "shard_id", b"shard_id"]) -> None: ...
...
class CreateShardKey(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["_replication_factor", b"_replication_factor", "_shards_number", b"_shards_number", "replication_factor", b"replication_factor", "shard_key", b"shard_key", "shards_number", b"shards_number"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["_replication_factor", b"_replication_factor", "_shards_number", b"_shards_number", "placement", b"placement", "replication_factor", b"replication_factor", "shard_key", b"shard_key", "shards_number", b"shards_number"]) -> None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing.Literal["_replication_factor", b"_replication_factor"]) -> typing.Literal["replication_factor"] | None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing.Literal["_shards_number", b"_shards_number"]) -> typing.Literal["shards_number"] | None: ...
...
class DeleteShardKey(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["shard_key", b"shard_key"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["shard_key", b"shard_key"]) -> None: ...
...
class CreateShardKeyRequest(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["_timeout", b"_timeout", "request", b"request", "timeout", b"timeout"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["_timeout", b"_timeout", "collection_name", b"collection_name", "request", b"request", "timeout", b"timeout"]) -> None: ...
    def WhichOneof(self, oneof_group: typing.Literal["_timeout", b"_timeout"]) -> typing.Literal["timeout"] | None: ...
