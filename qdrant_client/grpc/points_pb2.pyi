...
class Expression(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["abs", b"abs", "condition", b"condition", "constant", b"constant", "div", b"div", "exp", b"exp", "geo_distance", b"geo_distance", "ln", b"ln", "log10", b"log10", "mult", b"mult", "neg", b"neg", "pow", b"pow", "sqrt", b"sqrt", "sum", b"sum", "variable", b"variable", "variant", b"variant"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["abs", b"abs", "condition", b"condition", "constant", b"constant", "div", b"div", "exp", b"exp", "geo_distance", b"geo_distance", "ln", b"ln", "log10", b"log10", "mult", b"mult", "neg", b"neg", "pow", b"pow", "sqrt", b"sqrt", "sum", b"sum", "variable", b"variable", "variant", b"variant"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["variant", b"variant"]) -> typing_extensions.Literal["constant", "variable", "condition", "geo_distance", "mult", "sum", "div", "neg", "abs", "sqrt", "pow", "exp", "log10", "ln"] | None: ...
...
class HardwareUsage(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["cpu", b"cpu", "payload_io_read", b"payload_io_read", "payload_io_write", b"payload_io_write", "vector_io_read", b"vector_io_read", "vector_io_write", b"vector_io_write"]) -> None: ...
