...
class AsyncQdrantServerless:
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        self._remote = AsyncQdrantRemote(
            url=url,
            api_key=api_key,
            grpc_port=grpc_port,
            prefer_grpc=True,
    ...
    async def close(self, grpc_grace: Optional[float] = None, **kwargs: Any) -> None:
        ...
        await self._remote.close(grpc_grace=grpc_grace, **kwargs)
    ...
    async def create_collection(
        ...
        response = await self._collections.CreateCollection(
            pb2.CreateCollectionRequest(
                collection_name=collection_name, config=collection_config_to_grpc(config)
            ),
            timeout=self._collections_timeout(timeout),
        )
        return response.result

    async def delete_collection(self, collection_name: str, timeout: Optional[int] = None) -> bool:
    ...
    async def get_collection(
        ...
        """
        response = await self._collections.GetCollection(
    ...
    async def collection_exists(self, collection_name: str, timeout: Optional[int] = None) -> bool:
    ...
    async def retrieve(
        ...
        """
        return await self._remote.retrieve(
            collection_name=collection_name,
            ids=ids,
            with_payload=with_payload,
            with_vectors=with_vectors,
    ...
    async def scroll(
        ...
        """
        return await self._remote.scroll(
            collection_name=collection_name,
    ...
    async def count(
        ...
        """
        return await self._remote.count(
            collection_name=collection_name,
    ...
    async def upsert(
        ...
        """
        return await self._remote.upsert(
