CACHE_STR_PATH = {
    ...
    "Prefetch": [
        ...
        "prefetch.query.relevance_feedback.feedback.example",
        "prefetch.query.relevance_feedback.target",
        "query",
        ...
        "query.relevance_feedback.feedback.example",
        "query.relevance_feedback.target",
    ],
    "ProductQuantization": [],
    ...
    "QueryRequestBatch": [
        ...
        "searches.prefetch.query.relevance_feedback.feedback.example",
        "searches.prefetch.query.relevance_feedback.target",
        "searches.query",
        ...
        "searches.query.relevance_feedback.feedback.example",
...
DEFS = {
    ...
    "NaiveFeedbackStrategyParams": {
        "additionalProperties": False,
        "properties": {
            "a": {"description": "", "title": "A", "type": "number"},
            "b": {"description": "", "title": "B", "type": "number"},
            "c": {"description": "", "title": "C", "type": "number"},
        },
        "required": ["a", "b", "c"],
    ...
    "UpdateMode": {
        "description": "Defines the mode of the upsert operation  * `upsert` - default mode, insert new points, update existing points * `insert_only` - only insert new points, do not update existing points * `update_only` - only update existing points, do not insert new points",
    ...
    "FeedbackItem": {
        ...
        "properties": {
            ...
            "score": {"description": "", "title": "Score", "type": "number"},
        },
    ...
    "NaiveFeedbackStrategy": {
        "additionalProperties": False,
        "properties": {
            "naive": {"$ref": "#/$defs/NaiveFeedbackStrategyParams", "description": ""}
        },
        "required": ["naive"],
        ...
        "properties": {
            ...
            "query": {
                "anyOf": [
                    ...
                    {"$ref": "#/$defs/RelevanceFeedbackQuery"},
                    {"type": "null"},
                ],
                "default": None,
    ...
    "RelevanceFeedbackInput": {
        ...
        "properties": {
            ...
            "strategy": {"$ref": "#/$defs/NaiveFeedbackStrategy", "description": ""},
        },
        "required": ["target", "feedback", "strategy"],
    ...
    "RelevanceFeedbackQuery": {
        "additionalProperties": False,
        "properties": {
            "relevance_feedback": {"$ref": "#/$defs/RelevanceFeedbackInput", "description": ""}
        },
        "required": ["relevance_feedback"],
    ...
    "PointsBatch": {
        ...
        "properties": {
            ...
            "update_mode": {
                "anyOf": [{"$ref": "#/$defs/UpdateMode"}, {"type": "null"}],
                "default": None,
